...
public class RCFTPlanTimeGenerator implements Meter {

    private static final Logger logger = LoggerFactory.getLogger(RCFTPlanTimeGenerator.class);
     ...
     */
    @Autowired
    public RCFTPlanTimeGenerator(MeasurementInstanceService measurementInstanceService, CDMPCImportStepMeasurementValueCalculator valueCalculator) {
