...
public class NFDPlanTimeGenerator implements Meter {
     ...
     */
    @Autowired
    public NFDPlanTimeGenerator(MeasurementInstanceService measurementInstanceService, CDMPCImportStepMeasurementValueCalculator valueCalculator) {
