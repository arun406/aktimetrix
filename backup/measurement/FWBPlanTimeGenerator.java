...
public class FWBPlanTimeGenerator implements Meter {

    private static final Logger logger = LoggerFactory.getLogger(FWBPlanTimeGenerator.class);
     ...
     */
    public FWBPlanTimeGenerator(MeasurementInstanceService measurementInstanceService) {
