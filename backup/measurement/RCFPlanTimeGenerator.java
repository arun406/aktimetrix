...
public class RCFPlanTimeGenerator implements Meter {
     ...
     */
    @Autowired
    public RCFPlanTimeGenerator(MeasurementInstanceService measurementInstanceService, CDMPCImportStepMeasurementValueCalculator valueCalculator) {
