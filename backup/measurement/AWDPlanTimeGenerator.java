...
public class AWDPlanTimeGenerator implements Meter {

    private static final Logger logger = LoggerFactory.getLogger(AWDPlanTimeGenerator.class);
     ...
     */
    @Autowired
    public AWDPlanTimeGenerator(MeasurementInstanceService measurementInstanceService, CDMPCImportStepMeasurementValueCalculator valueCalculator) {
