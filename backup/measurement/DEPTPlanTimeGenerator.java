...
@Component
@Measurement(code = "TIME", stepCode = "DEP-T")
public class DEPTPlanTimeGenerator implements Meter {

    private static final Logger logger = LoggerFactory.getLogger(DEPTPlanTimeGenerator.class);
     ...
     */
    @Autowired
    public DEPTPlanTimeGenerator(MeasurementInstanceService measurementInstanceService, CDMPCImportStepMeasurementValueCalculator valueCalculator) {
