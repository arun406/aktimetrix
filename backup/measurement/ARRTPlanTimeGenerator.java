...
public class ARRTPlanTimeGenerator implements Meter {

    private static final Logger logger = LoggerFactory.getLogger(ARRTPlanTimeGenerator.class);
     ...
     */
    @Autowired
    public ARRTPlanTimeGenerator(MeasurementInstanceService measurementInstanceService, CDMPCImportStepMeasurementValueCalculator valueCalculator) {
