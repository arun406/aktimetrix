 ...
 */
@Component
public class PostProcessorPostBeanProcessor implements BeanPostProcessor {

    private static final Logger logger = LoggerFactory.getLogger(PostProcessorPostBeanProcessor.class);

    private final Registry registry;

    @Autowired
    public PostProcessorPostBeanProcessor(Registry registry) {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        attributes.put(Constants.ATT_POST_PROCESSOR_PROCESS_TYPE, annotation.processType().name());
