...
@ToString
@Builder
public class MeasurementInstanceDTO implements Serializable {
     ...
     * @param createdOn
     */
    public MeasurementInstanceDTO(String tenant, String id, String processInstanceId, String stepInstanceId, String stepCode,
